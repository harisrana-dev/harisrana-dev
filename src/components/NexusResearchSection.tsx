...
const rrfNDGValues = [0.362, 0.438, 0.455, 0.493, 0.498, 0.494, 0.491] // approximate from sweep
...
// ---------------------------------------------------------------------------
// Helper: bar chart height percentage (0-100% of max value)
// ---------------------------------------------------------------------------
...
function StrategyCard({ s, ndcgMax }: { s: typeof baselines[0]; ndcgMax: number }) {
  ...
  return (
    <article className={'nrx-strategy-card' + (isHybrid ? ' nrx-strategy-highlight' : '')} data-reveal>
...
function ThreatCard({ title, text }: { title: string; text: string }) {
  return (
    <div className="nrx-threat" data-reveal>
...
function TerminalBlock({ commands }: { commands: typeof evalCommands }) {
  return (
    <div className="nrx-terminal" data-reveal>
...
export function NexusResearchSection() {
  ...
  return (
    <section id="research" className="nrx-research shell">
      ...
      {/* ── Hero metadata ── */}
      <div className="nrx-hero-row" data-reveal>
        <div className="nrx-hero-title">
      ...
      {/* ── Research Questions ── */}
      <div className="nrx-rq-block" data-reveal>
      ...
      <div className="nrx-pipeline-block" data-reveal>
      ...
      <div className="nrx-results-block">
        <h4 className="nrx-sub" data-reveal>Baseline Comparison</h4>
        <p className="nrx-results-intro" data-reveal>
      ...
      <div className="nrx-stats-row" data-reveal>
      ...
      <div className="nrx-ablation-block" data-reveal>
      ...
      <div className="nrx-negative-block" data-reveal>
      ...
      <div className="nrx-validation-block" data-reveal>
      ...
      <div className="nrx-rigor-block" data-reveal>
      ...
      <div className="nrx-threats-block">
        <h4 className="nrx-sub" data-reveal>Threats to Validity</h4>
        <p className="nrx-threats-intro" data-reveal>
      ...
      {/* ── Human Evaluation ── */}
      <div className="nrx-human-block" data-reveal>
      ...
      {/* ── Reproducibility ── */}
      <div className="nrx-repro-block" data-reveal>
      ...
      {/* ── Research Output ── */}
      <div className="nrx-output-block" data-reveal>
      ...
      {/* ── Impact + Links ── */}
      <div className="nrx-impact-block" data-reveal>
