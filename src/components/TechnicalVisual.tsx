...
export function TechnicalVisual({ kind, label }: { kind: VisualKind; label: string }) {
  if (kind === 'vision') return <div className="technical-visual vision-visual" role="img" aria-label={label}>
  ...
  if (kind === 'pipeline') return <div className="technical-visual pipeline-visual" role="img" aria-label={label}>
  ...
  if (kind === 'architecture') return <div className="technical-visual architecture-visual" role="img" aria-label={label}>
  ...
  return <div className="technical-visual mini-telemetry" role="img" aria-label={label}>
